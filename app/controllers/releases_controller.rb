class ReleasesController < ApplicationController
  ...
  private
    ...
    def release_params
      params.require(:release).permit(:component, :jira_fix_version, :status, :dev_start, :code_freeze, :qa_start, :qa_end, :planned_release, :actual_release, :reason_for_variance, :release_details, :user_id)
    end
end
